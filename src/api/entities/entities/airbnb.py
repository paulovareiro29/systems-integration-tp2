...
class Airbnb:
    def __init__(self, name,  host_id, geom=None, latitude=None, longitude=None, price=0, neighbourhood=None, type_id=None, area_id=None, id=None, created_on=None, updated_on=None):
